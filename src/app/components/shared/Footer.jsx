...
function Footer() {
  ...
  <div class=" mt-0 w-full [border-bottom:1.7px_solid_rgb(0,_0,_0)]"></div>
    <div class="flex mb-4 flex-row justify-center ">
      <div class="text-center mx-auto font-semibold max-[991px]:ml-0 max-[991px]:mr-0 max-[991px]:py-1 max-[479px]:mb-4 sm:text-center">
        ...
        <a href="#" class="relative px-4  after:absolute  after:bg-blue-500 after:bottom-0 after:left-0 after:h-[2px] after:w-full after:origin-bottom-right after:scale-x-0 hover:after:origin-bottom-left hover:after:scale-x-100 after:transition-transform after:ease-in-out after:duration-300">Became a Instructor</a>
  ...
  <div class="bg-gray-100">
    <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p class="text-gray-500 text-sm text-center sm:text-left">© 2020 Skill Darpan —
        <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" class="text-black ml-1" target="_blank">@Skill Darpan</a>
      </p>
